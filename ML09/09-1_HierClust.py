...
#    - We use scipy, because it is not (yet) possible to drwa a dendogram from the scikit-learn model.
...
#           - In clustering, we are CREATING a new attribute (the cluster label) based on the data structure.
